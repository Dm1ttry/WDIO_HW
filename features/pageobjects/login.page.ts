...
export default  class LoginPage {
    public openLogin(){
        return browser.url('https://passport.yandex.ru/auth?origin=kinopoisk&retpath=https%3A%2F%2Fsso.passport.yandex.ru%2Fpush%3Fretpath%3Dhttps%253A%252F%252Fwww.kinopoisk.ru%252F%253Futm_referrer%253Dwww.google.com%26uuid%3D5a9a361e-1f62-42d9-b3bb-14cce95fa327')
    }
